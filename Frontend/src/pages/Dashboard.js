...
const Dashboard = () => {
  ...
  const features = [
    { title: "Help Requests", description: "Request or offer tools, skills, and services.", link: "/" },
    { title: "Booking Public Spaces", description: "Easily book or rent spaces across neighborhoods.", link: "/" },
    { title: "Parking Rentals", description: "Easily share or rent parking spaces across neighborhoods hassle-free.", link: "/" }
  ];
